...
//               ADDITION
if (answer.optr === "+") {
    console.log(chalk.green("The desired Result is : ") + sumF(answer.firstNum, answer.secondNum));
}
//               SUBTRACTION
else if (answer.optr === "-") {
...
//              DIVISION
    ...
    console.log(chalk.cyan("The desired Result is : ") + divF(answer.firstNum, answer.secondNum));
}
//              MULTIPLICATION
else if (answer.optr === "*") {
    console.log(chalk.yellow("The desired Result is : ") + mulF(answer.firstNum, answer.secondNum));
}
